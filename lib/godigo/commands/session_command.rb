...
EOS
    ...
    def sync_command
      ...
      cmd = cmd + "#{rsync_path} --recursive --links --times --group --owner --devices --specials --verbose --progress --human-readable --delete --chmod=u+rwx -e #{ssh_path} ./ #{dst_path}" # -a == -rlptgoD
    end
